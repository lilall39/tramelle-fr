...
export const outils: OutilMeta[] = [
  {
    ...
    title: "Sur consigne",
    tagline:
      "Vous lui donnez une consigne, il s’adapte. Corriger, rédiger, poésie, dissertation, traduire, répondre à une question, expliquer un sujet ou développer une idée — selon ce que vous lui demandez.",
    description:
